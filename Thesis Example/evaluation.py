...
class Evaluation():
    ...
    def robustness(self, data, interpretation_techniques, voc): #chi the technique from which we will pick the change
        skipped = 0
        robustness = []
        ...
        for ind in range(len(data)):
            ...
            interpretations_dif = np.abs((np.array(interpretations) - np.array(interpretations_c)))
